...
export default function Prescriptions({ user }) {
 ...
 <div style={{ width: 44, height: 44, borderRadius: '50%', background: `${C.primary}15`, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', color: C.primary, flexShrink: 0 }}>
 {rx.doctor_avatar ? <img src={rx.doctor_avatar} style={{width:'100%', height:'100%', objectFit:'cover'}} alt="doctor" /> : <div style={{fontSize: 20}}>⚕️</div>}
 </div>
 <div>
 ...
 <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
   <div style={{ width: 36, height: 36, borderRadius: '50%', background: `${C.primary}15`, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', color: C.primary, flexShrink: 0 }}>
     {selected.doctor_avatar ? <img src={selected.doctor_avatar} style={{width:'100%', height:'100%', objectFit:'cover'}} alt="doctor" /> : <div style={{fontSize: 16}}>⚕️</div>}
   </div>
   <div>
