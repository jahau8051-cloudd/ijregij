...
export default function SignInPage({ onSuccess, onNav }) {
 ...
 <div className="fade auth-box" style={{ position: 'relative', background: '#fff', borderRadius: 20, padding: 44, width: '100%', maxWidth: 420, boxShadow: '0 24px 80px rgba(0,0,0,0.35)' }}>
